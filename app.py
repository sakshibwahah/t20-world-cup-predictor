...
with tab_pred:
    ...
    with col_in2:
        ov = st.number_input("Overs", min_value=0, max_value=20, step=1)
    with col_in3:
        bl = st.number_input("Balls", min_value=0, max_value=5, step=1)
    with col_in4:
    ...
    balls_bowled = (ov * 6) + bl
    balls_left = 120 - balls_bowled
    wickets_left = 10 - wickets
    # Calculate mathematical overs for CRR/RRR
    actual_overs = balls_bowled / 6
    crr = current_score / actual_overs if actual_overs > 0 else 0
